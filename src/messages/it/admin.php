...
// 2.0
    ...
    'model_tag_translation' => 'Traduzione',
    'model_tag_translation_hint' => 'Traduzione opzionale per il tag nella lingua data. Questo permette di assegnare e mostrare lo stesso tag su siti web multi lingua.',
    'active_button_timestamp_label' => 'Timestamp',
    'active_button_timestamp_success' => 'Timestamp è stato settato con successo.',
    'active_button_timestamp_error' => 'Errore durante il salvataggio del timestamp.',
    'js_scheduler_show_datepicker' => 'Schedulazione',
    'js_scheduler_new_value' => 'Nuovo valore',
    'js_scheduler_time' => 'Tempo di esecuzione',
    'js_scheduler_save' => 'Aggiungi',
    'js_scheduler_title_upcoming' => 'Prossimo evento da schedulare',
    'js_scheduler_title_completed' => 'Completato',
    'js_scheduler_table_newvalue' => 'Nuovo valore',
    'js_scheduler_table_timestamp' => 'Tempo di esecuzione',
    'js_dir_manager_rename_success' => 'La cartella è stata rinominata con succeso.',
    'layout_filemanager_search_no_results' => 'Nessun file è stato trovato per <strong>{{searchQuery}}</strong>.',
    'layout_filemanager_empty_folder' => 'Cartella vuota.',
    'aw_requestinsight_warning' => 'caratteristica usata principalmente per ottenere informazioni per una determinata API. Non e\' raccomandato abilitarlo a lungo poichè può raccogliere molti dati e rallentare l\'applicazione.',
    'aw_requestinsight_logger_active' => 'La richiesta di informazione e\' correntemente attivo!',
    'aw_requestinsight_btn_disable' => 'Disabilita informazioni',
    'aw_requestinsight_btn_enable' => 'Abilita informazioni',
    'aw_requestinsight_btn_clear' => 'Pulisci dati',
    'aw_requestinsight_btn_fetch' => 'Recupera dati',
    'aw_requestinsight_request_label' => 'Richieste',
    ...
    'aw_requestinsight_col_count' => 'Conteggio',
    'aw_requestinsight_top_request_label' => 'Top URL richieste',
    'aw_requestinsight_longest_response_label' => 'URL con maggior tempo di risposta',
    'aw_requestinsight_data_pagination' => '{{data.length}} di {{dataCount}} richieste',
    'aw_requestinsight_toggle_logger_enabled' => 'Informazione abilitata.',
    'aw_requestinsight_toggle_logger_disabled' => 'Informazione disabilitata.',
    'aw_requestinsight_toggle_error' => 'Errore durante abilitazione Richiesta di Informazione.',
    'aw_requestinsight_cleared' => 'Dati sono stati puliti.',
    'aw_requestinsight_default_label' => 'Richiesta di Informazione',
    'login_noscript_error' => 'Devi attivare Javascript per usare LUYA.',
    'login_browsehappy' => 'Stai usando un browser <strong>obsoleto</strong>. Per favore, <a href="https://browsehappy.com/" target="_blank">aggiorna il tuo browser</a> per migliorare esperienza e sicurezza.',
    'crud_notification_enable' => 'Abilita Notifiche',
    'crud_notification_disable' => 'Disabilita Notifiche',
    'admin_button_execute' => '"{label}" eseguita',
    'layout_btn_reload_admin' => 'Ricarica&nbsp;Amministratore',
    'layout_btn_reload_cache' => 'Pulisci&nbsp;Cache',
